...
export const COMMON_TIMEZONES = ['Europe/Madrid','Atlantic/Canary','Europe/London','Europe/Paris','America/New_York','America/Los_Angeles','America/Mexico_City','America/Argentina/Buenos_Aires','Asia/Tokyo','Asia/Shanghai','Australia/Sydney','UTC'] as const;
